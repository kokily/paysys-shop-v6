...
import { convertWeddingToResult } from '@/utils/convert';
...
function ReadWeddingFirst({ wedding }: Props) {
  const result = convertWeddingToResult(wedding);

  return (
    <table className='read-wedding-first-container'>
      <thead>
        <tr>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td className='result'>
            {unitOfAccount(result.husband_cost, '원')}
          </td>
          <td className='result'>
            {unitOfAccount(result.bride_cost, '원')}
          </td>
          <td className='sub-result'>
            {unitOfAccount(result.husband_cost + result.bride_cost, '원')}
          </td>
        </tr>
      </tbody>
    </table>
